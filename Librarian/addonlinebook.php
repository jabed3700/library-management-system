              ...
              <form role="form" method="POST" action="addonliebook_core.php" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <label for="exampleInputdetname">Book Title</label>
                    <input type="text" required id="exampleInputdetname" name="name" class="form-control" placeholder="Enter Book Title ">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input required type="file" name="bpp" class="form-control-file" id="exampleInputFile5">
                  </div>
